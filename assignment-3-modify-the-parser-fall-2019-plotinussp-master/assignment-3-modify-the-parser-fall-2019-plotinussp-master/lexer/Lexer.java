...
public class Lexer {
  ...
  public Token newStringLit( String StringLit, int startPosition, int endPosition) {
    return new Token(
      startPosition,
      endPosition,
      source,
  ...
  public Token newNumberLit( String NumberLit, int startPosition, int endPosition) {
    return new Token(
      startPosition,
      endPosition,
      source,
      Symbol.symbol( NumberLit, Tokens.StringLit )
    );
  }
  /**
  ...
  public Token nextToken() {
    ...
    if( ch == '\"') {
      ...
      return newStringLit( stringLit, startPosition, endPosition);
    }
    ...
    if( ch == '\"') {
      ...
      try{
        ...
        return newNumberLit(numberLit, startPosition, endPosition);
  ...
  public void resetSource(String sourceFile){
    try{
      source = new SourceReader( sourceFile );
    }
    catch (Exception e){}
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      while (token != null) {
        ...
        System.out.printf("%-11s ", p);
        System.out.printf("left: %-8s ", token.getLeftPosition());
        System.out.printf("right: %-8s ", token.getRightPosition());
        System.out.printf("line: %-8s ", lex.source.getLineno());
        System.out.printf("%s %n", token.getKind());
        token = lex.nextToken();
      }
      System.out.printf("%n");
